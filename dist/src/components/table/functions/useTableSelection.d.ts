...
export declare function useTableSelection(props: VTableProps, sortedData: ComputedRef<Record<string, any>[]>, emit: (...args: any[]) => void, allData?: ComputedRef<Record<string, any>[]>): {
    ...
    isDoubleCheck: ComputedRef<boolean | undefined>;
