<script lang="ts" setup>
  ...
  import { minLength, noSpaces, required, useValidate } from '@/validation';
  ...
  const rules = {
    ...
    password: [required, minLength(3), noSpaces],
  };
    ...
    <div class="vt-login__wrapper">
      ...
      <div v-loader="props.loading" class="vt-login__form">
        <div class="vt-login__form-item">
          <div class="vt-login__form-label vt-login__form-label__required">
        ...
        <div class="vt-login__form-item">
          <div class="vt-login__form-label">
        ...
        <div class="vt-login__form-item">
          <VButton :disabled="props.loading" class="vt-login__form-submit" type="primary" @click="submit">
            {{ t(LOCALE_KEYS.LOGIN_SUBMIT) }}
          </VButton>
        </div>

        <div class="vt-login__form-item vt-login__form-item--center">
          <a :href="props.privacyPolicyUrl" class="vt-login__link" target="_blank">{{
            t(LOCALE_KEYS.LOGIN_PRIVACY_POLICY)
          }}</a>
        </div>
      </div>
    </div>
