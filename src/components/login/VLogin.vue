...
const rules = {
  ...
  password: [required, minLength(3), containUpperCaseLetter, noSpaces],
};
    ...
    <div class="vt-login__wrapper">
      ...
      <div v-loader="props.loading" class="vt-login__form">
        ...
        <div class="vt-login__form-item vt-login__form-item--center">
          <a :href="props.privacyPolicyUrl" class="vt-login__link"
             target="_blank">{{ t(LOCALE_KEYS.LOGIN_PRIVACY_POLICY) }}</a>
        </div>
