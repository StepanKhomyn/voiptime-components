...
import ForwardIcon from './actions/ForwardIcon.vue';
...
import ArrowNewLineIcon from './arrow/ArrowNewLineIcon.vue';
...
import FolderIcon from './files/FolderIcon.vue';
...
import EmailDraftIcon from './mail/EmailDraftIcon.vue';
import EmailIcon from './mail/EmailIcon.vue';
import EmailIncomingIcon from './mail/EmailIncomingIcon.vue';
import EmailNewIcon from './mail/EmailNewIcon.vue';
...
import VariableIcon from './scenario/VariableIcon.vue';
...
export const icons = {
  ...
  // mail icons
  emailDeleted: EmailDeletedIcon,
  emailDraft: EmailDraftIcon,
  email: EmailIcon,
  emailIncoming: EmailIncomingIcon,
  emailNew: EmailNewIcon,
